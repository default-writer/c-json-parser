...
The in-memory representation centers around the `json_value` data structure (declared in [json.h](/projects/376/80073)), which uses a tagged union pattern to represent any JSON type:
...
- When setting object keys with [json_object_set_take_key](/projects/376/80073), the module takes ownership of the key slice and the associated value, managing duplicate keys by replacing existing entries.
- The [json_free](/projects/376/80073) function recursively frees all allocated memory, including nested arrays, objects, and the `json_value` wrappers themselves.
...
- Objects provide [json_object_get](/projects/376/80073) to retrieve values by key efficiently.
- Arrays support element addition via [json_array_push](/projects/376/80073).
- Equality checks ([json_equal](/projects/376/80077)) recursively compare JSON trees for structural equivalence.
...
- The testing framework invokes [json_parse](/projects/376/80073) to verify parser correctness against various JSON inputs.
...
## Summary of Main Functions (in [src/json.c](/projects/376/80075))

- [json_parse](/projects/376/80073) — Entry point for parsing a JSON string.
...
- [json_object_set_take_key](/projects/376/80073) — Inserts or updates object key-value pairs.
- [json_object_get](/projects/376/80073) — Retrieves values by key.
- [json_equal](/projects/376/80077) — Recursively compares two JSON trees.
- [json_free](/projects/376/80073) — Recursively frees JSON tree memory.
- [json_print](/projects/376/80073) — Pretty-prints JSON tree to output.
