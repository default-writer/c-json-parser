...
3. **Manipulating JSON Values**  
   Use functions like `json_array_push()` to append elements to arrays or [json_object_set_take_key()](hhttps://nextdocs.ai/github/default-writer/c-json-parser/80075) to set key-value pairs in objects.
