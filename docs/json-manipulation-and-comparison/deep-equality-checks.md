...
The core function implementing this logic is `json_equal()`, which performs type checks and delegates to specialized helpers for arrays (`json_array_equal()`) and objects ([json_object_equal()](../../src/json.c)).
