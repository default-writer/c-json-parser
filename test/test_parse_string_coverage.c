...
TEST(test_parse_string_full_coverage) {
  ...
  bool result1 = json_parse(test1, test1 + test1_len, &test_val);
  ASSERT_TRUE(result1);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result2 = json_parse(test2, test2 + test2_len, &test_val);
  ASSERT_TRUE(result2);
  ASSERT_EQ(test_val.u.array.items->item.type, J_STRING);
  json_free(&test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result3 = json_parse(test3, test3 + test3_len, &test_val);
  ASSERT_TRUE(result3);
  ASSERT_EQ(test_val.u.array.items->item.type, J_STRING);
  json_free(&test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result4 = json_parse(test4, test4 + test4_len, &test_val);
  ASSERT_TRUE(result4);
  ASSERT_EQ(test_val.u.array.items->item.type, J_STRING);
  json_free(&test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result5 = json_parse(test5, test5 + test5_len, &test_val);
  ASSERT_TRUE(result5);
  ASSERT_EQ(test_val.u.array.items->item.type, J_STRING);
  json_free(&test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result6 = json_parse(test6, test6 + test6_len, &test_val);
  ASSERT_FALSE(result6);

  const char *test7 = "\"\\ug\"";
  size_t test7_len = strlen(test7);
  memset(&test_val, 0, sizeof(json_value));
  bool result7 = json_parse(test7, test7 + test7_len, &test_val);
  ASSERT_FALSE(result7);

  const char *test8 = "[\"\\uD83D\\uDE00\"]";
  size_t test8_len = strlen(test8);
  memset(&test_val, 0, sizeof(json_value));
  bool result8 = json_parse(test8, test8 + test8_len, &test_val);
  ASSERT_TRUE(result8);
  ASSERT_EQ(test_val.u.array.items->item.type, J_STRING);
  json_free(&test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result9 = json_parse(test9, test9 + test9_len, &test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result10 = json_parse(test10, test10 + test10_len, &test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result11 = json_parse(test11, test11 + test11_len, &test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result12 = json_parse(test12, test12 + test12_len, &test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result13 = json_parse(test13, test13 + test13_len, &test_val);
  ...
  memset(&test_val, 0, sizeof(json_value));
  bool result14 = json_parse(test14, test14 + test14_len, &test_val);
